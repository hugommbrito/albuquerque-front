			...
			<div className=" grid gap-10 md:grid-cols-[1.5fr_1fr] items-start">
				<div className="space-y-6">
					...
					<h2 className="text-32 md:text-48 font-500 text-primary max-w-[42ch]">
						Dez anos de história, criando soluções e obras construtivas para você desfrutar com segurança e felicidade.
					</h2>
					<ButtonLinkAbq
						href="/nossa-historia"
						text="Saiba mais"
				...
				<div className="grid gap-6 sm:grid-cols-2">
					...
					<div className="h-50 col-span-2 rounded-3xl border border-primary/20 p-6 flex flex-col justify-between">
						...
						<div className="text-12 uppercase tracking-wide text-primary-3">
							certificações e métodos modernos de construção
						</div>
					</div>
				</div>
			</div>
