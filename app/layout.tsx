      ...
      <body className="antialiased">
        <header className="border-b border-white bg-white">
          <div className="mx-auto flex max-w-6xl items-center gap-10 px-6 py-4 text-sm font-medium text-primary">
            ...
            <Link href="/" className="flex items-center gap-2 text-base font-semibold lowercase tracking-tight ">
        ...
        <main>{children}</main>
        <footer className="border-t border-primary bg-primary text-primary-invert">
          <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 text-sm">
            ...
            <div className="grid gap-8 text-sm sm:grid-cols-3">
              <div className="space-y-3">
                <h2 className="text-xs font-semibold uppercase tracking-wide text-primary-invert">Contato</h2>
                <p className="text-primary-invert">contato@albuquerque.com.br</p>
                <p className="text-primary-invert">+55 (11) 4002-8922</p>
              </div>
              <div className="space-y-3">
                <h2 className="text-xs font-semibold uppercase tracking-wide text-primary-invert">Visite</h2>
                <p className="text-primary-invert">
                  Avenida dos Sonhos, 1234<br />São Paulo - SP
                </p>
              </div>
              <div className="space-y-3">
                <h2 className="text-xs font-semibold uppercase tracking-wide text-primary-invert">Explore</h2>
                <div className="flex flex-wrap gap-4 text-primary-invert">
                  <Link href="/nossas-obras" className="transition hover:text-primary">
                    Nossas obras
                  </Link>
                  <Link href="/nossa-historia" className="transition hover:text-primary">
                    Nossa história
                  </Link>
                  <Link href="/seu-sonho" className="transition hover:text-primary">
                    Seu sonho
                  </Link>
            ...
            <div className="flex flex-col gap-4 border-t border-primary-invert pt-6 text-xs text-primary-invert sm:flex-row sm:items-center sm:justify-between">
              <p>&copy; 2025 Construtora Albuquerque. Todos os direitos reservados.</p>
